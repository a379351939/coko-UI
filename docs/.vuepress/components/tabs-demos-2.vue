<template>
  <div class="example-box">
    <c-tabs selected="2" direction="vertical">
      <c-tabs-head>
        <c-tabs-item name="1">阿三1</c-tabs-item>
        <c-tabs-item name="2">2</c-tabs-item>
      </c-tabs-head>
      <c-tabs-body>
        <c-tabs-panel name="1">content 1</c-tabs-panel>
        <c-tabs-panel name="2">content 2</c-tabs-panel>
      </c-tabs-body>
    </c-tabs>
    ...
    data () {
      return {
        content: `
          <c-tabs selected="2">
            <c-tabs-head>
              <c-tabs-item name="1">1</c-tabs-item>
              <c-tabs-item name="2">2</c-tabs-item>
            </c-tabs-head>
            <c-tabs-body>
              <c-tabs-panel name="1">content 1</c-tabs-panel>
